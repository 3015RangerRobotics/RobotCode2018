...
//        addSequential(new DriveMotionProfile("wallToRightScale", isRightStart));
        ...
        addSequential(new DriveMotionProfile(MotionProfiles.generate1D(1.5, 14, 14, 200, true)));
        ...
        addSequential(new DriveMotionProfile(MotionProfiles.generate1D(4, 14, 10, 200, false)));
        addSequential(new GrabberCubeEject());
        addSequential(new DriveMotionProfile(MotionProfiles.generate1D(2, 14, 14, 200, true)));
