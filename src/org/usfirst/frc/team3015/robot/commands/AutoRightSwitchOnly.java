...
public class AutoRightSwitchOnly extends CommandGroup {
    ...
    public AutoRightSwitchOnly() {
        ...
        addSequential(new DriveMotionProfile(MotionProfiles.generate2D(5, 0, 52, 14, 14, 200, true)));
        	addSequential(new DriveMotionProfile(MotionProfiles.generate1D(3.2, 14, 14, 200, false)));
//        addSequential(new ObtainCube(3.2));
        addSequential(new DriveMotionProfile(MotionProfiles.generate2D(3.2, 0, -52, 14, 14, 200, true)));
        addParallel(new ElevatorToSwitch());
        addSequential(new DriveMotionProfile(MotionProfiles.generate1D(4.25, 14, 14, 200, false)));
        addSequential(new GrabberCubeEject());
        addParallel(new ElevatorToBottomDelayed(0.25));
        addSequential(new DriveMotionProfile(MotionProfiles.generate2D(3.8, 0, 52, 14, 14, 200, true)));
        	addSequential(new DriveMotionProfile(MotionProfiles.generate1D(2.6, 14, 14, 200, false)));
//        addSequential(new ObtainCube(2.6));
        addSequential(new DriveTurnToAngleEncoders(50));
        addParallel(new ElevatorToSwitch());
        addSequential(new DriveMotionProfile(MotionProfiles.generate1D(2.3, 14, 14, 200, false)));
        addSequential(new GrabberCubeEject());
