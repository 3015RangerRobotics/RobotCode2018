...
public class AutoLeftSwitchOnly extends CommandGroup {
    ...
    public AutoLeftSwitchOnly() {
        ...
        addSequential(new DriveMotionProfile(MotionProfiles.generate2D(5, 0, -56, 14, 14, 100, true)));
        addSequential(new ObtainCube(3.7));
        addSequential(new DriveMotionProfile(MotionProfiles.generate2D(3.7, 0, 56, 14, 14, 100, true)));
        addParallel(new ElevatorToSwitch());
        addSequential(new DriveMotionProfile(MotionProfiles.generate1D(5, 14, 14, 100, false)));
        addSequential(new GrabberCubeEject());
        addParallel(new ElevatorToBottomDelayed(0.25));
        addSequential(new DriveMotionProfile(MotionProfiles.generate2D(4, 0, -50, 14, 14, 100, true)));
